...
export function EditProductForm({ product }: { product: Product }) {
  ...
  async function handleDelete() {
    if (!window.confirm("Delete this product? It will be hidden from the store.")) {
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="border-t border-border pt-6">
        <button
          ...
          disabled={loading || deleting}
          className="text-red-500 text-sm font-medium hover:text-red-400 disabled:opacity-40 transition-colors duration-200"
        >
